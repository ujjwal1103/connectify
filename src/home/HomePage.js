...
/* <div className="w-2/3 mx-auto p-4 flex gap-10 justify-center">
        <div className="flex flex-col items-center gap-2" onClick={createStory}>
          <BsPlus className="w-20 h-20 outline outline-offset-2 outline-violet-500 rounded-full" />

          <span>ujjwal lade</span>
        </div> 
       <Story /> 
      </div>  */

//   {story && <CreateStory setClose={createStory} />}
