  ...
  return (
    <>
      {uploadingPost.loading && (
        <div className="text-white bg-black  absolute top-0 w-screen left-0   rounded-md p-3 shadow-2xl z-50">
          <button className="absolute right-4" onClick={closeLoader}>
            <IoClose />
          </button>
      ...
      {uploadingPost.loading && (
        <div className="text-white hidden lg:block bg-black m-2 fixed bottom-auto lg:h-fit lg:bottom-0 w-96 lg:right-0 rounded-md p-3 shadow-2xl z-50">
          <button className="absolute right-4" onClick={closeLoader}>
            <IoClose />
          </button>
          <p className="text-center py-2">Posting</p>
